defmodule BmvpWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {BmvpWeb.Layouts, :root}
  ...
  scope "/", BmvpWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BmvpWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BmvpWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BmvpWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BmvpWeb do
    ...
    live_session :current_user,
      on_mount: [{BmvpWeb.UserAuth, :mount_current_user}] do
